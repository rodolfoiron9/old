...
export const PRESETS: Preset[] = [
  {
    ...
    wireframe: { enabled: true, color: '#ffffff', thickness: 1 },
    edges: { glow: 0.5, cornerRadius: 0.05 },
    faces: {
      front: { type: 'lyrics' },
      back: { type: 'albumArt' },
      left: { type: 'social', elements: ['like', 'share'] },
      right: { type: 'metadata', fields: ['artist', 'title'] },
      top: { type: 'staticText', text: 'Rudybtz' },
      bottom: { type: 'none' }
    },
    effects: { bassFracture: 0.2, chorusBloom: 0.5 },
  ...
  },
  {
    ...
    wireframe: { enabled: false, color: '#f56565', thickness: 1.5 },
    edges: { glow: 0.2, cornerRadius: 0 },
    faces: {
        front: { type: 'lyrics' },
        back: { type: 'albumArt' },
        left: { type: 'social', elements: ['like', 'share'] },
        right: { type: 'metadata', fields: ['artist', 'title'] },
        top: { type: 'staticText', text: 'Old Habit' },
        bottom: { type: 'none' }
    },
    effects: { bassFracture: 0, chorusBloom: 0.8 },
  ...
  },
  {
    ...
    wireframe: { enabled: true, color: '#4299e1', thickness: 2 },
    edges: { glow: 0.8, cornerRadius: 0.02 },
    faces: {
        front: { type: 'lyrics' },
        back: { type: 'albumArt' },
        left: { type: 'controls', buttons: ['next', 'prev'] },
        right: { type: 'metadata', fields: ['artist', 'title'] },
        top: { type: 'none' },
        bottom: { type: 'none' }
    },
    effects: { bassFracture: 0.8, chorusBloom: 0.2 },
  ...
  },
   {
    ...
    wireframe: { enabled: true, color: '#ffffff', thickness: 0.5 },
    edges: { glow: 0.9, cornerRadius: 0.1 },
    faces: {
        front: { type: 'lyrics' },
        back: { type: 'albumArt' },
        left: { type: 'social', elements: ['like', 'share', 'comment'] },
        right: { type: 'metadata', fields: ['artist', 'title', 'album'] },
        top: { type: 'aiVisual' },
        bottom: { type: 'none' }
    },
    effects: { bassFracture: 0.1, chorusBloom: 1.2 },
  ...
  },
  {
    ...
    wireframe: { enabled: false, color: '#ffffff', thickness: 1 },
    edges: { glow: 0.1, cornerRadius: 0 },
    faces: {
        front: { type: 'lyrics' },
        back: { type: 'albumArt' },
        left: { type: 'none' },
    ...
    effects: { bassFracture: 0, chorusBloom: 0.3 },
